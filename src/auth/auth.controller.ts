...
export class AuthController {
  ...
  async signIn(
    ...
    return await this.authService.signIn(singInDTO, response);
  }
  ...
  async logoutAllDevices(
    ...
    return await this.authService.logoutAllDevices(user, response);
  }
  ...
  async logout(
    ...
    return await this.authService.logout(session, response);
  }
